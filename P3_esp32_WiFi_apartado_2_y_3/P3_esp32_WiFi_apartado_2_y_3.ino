...
// WiFi
const char* ssid = "MOVISTAR_D1EC";//wifi clase :"ALUMNOS_CICLOS" MOVISTAR_D1EC
const char* password = "CDC574D8A95E6FDE69C1";//password clase :"Ciclos2025sz?" CDC574D8A95E6FDE69C1
